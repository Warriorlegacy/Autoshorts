 ...
 */
router.get('/stock-suggestions', async (req: Request, res: Response) => {
  try {
    ...
    const suggestions = await imageService.getStockImageSuggestions(
      niche,
 ...
 */
router.post('/stock-suggestions', async (req: Request, res: Response) => {
  try {
