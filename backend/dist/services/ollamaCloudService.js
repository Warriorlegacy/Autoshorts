...
exports.OllamaCloudService = void 0;
class OllamaCloudService {
    ...
    async generateVideoFromText(request) {
        if (!this.apiKey) {
...
Generate 3-5 scenes with smooth transitions. Make it viral-worthy!`;
        try {
            ...
            if (!response.ok) {
                ...
                const isClipboardError = errorText.includes('clipboard') ||
    ...
    async generateRemotionCode(prompt) {
        if (!this.apiKey) {
...
exports.OllamaCloudService = OllamaCloudService;
//# sourceMappingURL=ollamaCloudService.js.map