...
exports.SkyreelsService = void 0;
exports.getSkyreelsService = getSkyreelsService;
...
class SkyreelsService {
    constructor() {
        this.apiKey = config_1.API_KEYS.SKYREELS || '';
        this.baseUrl = config_1.SERVICE_URLS.SKYREELS_API;
     ...
     */
    async waitForCompletion(requestId, maxWaitMs = 600000, pollIntervalMs = 10000) {
        if (!this.isAvailable()) {
     ...
     */
    async generateWithTTS(avatarImage, narration, languageCode, voiceName, speakingRate, prompt) {
...
exports.SkyreelsService = SkyreelsService;
// Singleton instance
let skyreelsService = null;
function getSkyreelsService() {
    if (!skyreelsService) {
        skyreelsService = new SkyreelsService();
    }
    return skyreelsService;
}
//# sourceMappingURL=skyreelsService.js.map