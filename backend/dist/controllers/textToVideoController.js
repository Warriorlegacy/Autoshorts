...
exports.previewVideo = exports.generateTextToVideo = void 0;
...
const ollamaService = new ollamaCloudService_1.OllamaCloudService();
...
const generateTextToVideo = async (req, res) => {
    try {
        const { prompt, images, duration, style, language, voiceName, speakingRate } = req.body;
        ...
        let scenesWithAudio = await Promise.all(videoResult.scenes.map(async (scene, index) => {
            try {
...
exports.generateTextToVideo = generateTextToVideo;
...
//# sourceMappingURL=textToVideoController.js.map