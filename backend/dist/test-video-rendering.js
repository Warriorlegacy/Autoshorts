...
exports.VideoRenderingTest = void 0;
...
class VideoRenderingTest {
    constructor() {
        this.testVideoId = null;
        this.results = [];
        this.startTime = 0;
        this.renderingService = new renderingService_1.RenderingService();
    }
    /**
     * Log with timestamp
     */
    ...
    async createTestVideo() {
        ...
        try {
            ...
            const userResult = await (0, db_1.query)(`INSERT INTO users (id, email, password_hash) VALUES (?, ?, ?)`, [
                testUserId,
                testUserEmail,
            ...
            const result = await (0, db_1.query)(`INSERT INTO videos (id, user_id, title, caption, niche, language, duration, visual_style, status, scenes, metadata)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
                testVideoUUID,
                testUserId,
    ...
    async verifyOutput() {
        ...
        try {
            ...
            const outputPath = path_1.default.join(process.cwd(), 'public', 'renders', `${this.testVideoId}.mp4`);
    ...
    async checkVideoStatus() {
        ...
        try {
            ...
            const result = await (0, db_1.query)('SELECT id, status, video_url, thumbnail_url, updated_at FROM videos WHERE id = ?', [this.testVideoId]);
    ...
    async cleanup() {
        ...
        try {
            ...
            if (this.testVideoId) {
                await (0, db_1.query)('DELETE FROM videos WHERE id = ?', [this.testVideoId]);
...
exports.VideoRenderingTest = VideoRenderingTest;
...
//# sourceMappingURL=test-video-rendering.js.map